import LegDeadliftModel from './fitness-ar-deadlift-model';
import LegPressModel from './fitness-ar-legpress-model';
...
export default function FitnessLegsContent() {
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
        <div>
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Leg Workout Guide</h2>
          <p className="mt-4 text-gray-500">
            This guide is meant to aid you in targeting your leg and helping with developing both strength and growth. For in-depth info click <a href="https://fitnessprogramer.com/exercise-primary-muscle/leg/"> <span className='text-blue-300'>Here</span></a>
          </p>
        ...
        <div className="grid grid-cols-2 grid-rows-4 gap-4 sm:gap-6 lg:gap-8">
          <img
            alt="Dumbbell curls"
            src={require('./images/Stiff-Leg-Deadlift.gif')}
            className="rounded-lg bg-gray-100"
          />
          <img
            alt="Z Bar Preacher Curl"
            src={require('./images/BARBELL-SQUAT.gif')}
            className="rounded-lg bg-gray-100"
          />
          <img
            alt="Hammer Curls"
            src={require('./images/Barbell-Hip-Thrust.gif')}
            className="rounded-lg bg-gray-100"
          />
          <img
            alt="One Arm Cable Curl"
            src={require('./images/LEG-EXTENSION.gif')}
            className="rounded-lg bg-gray-100"
          />
          <img
            alt="Forarm Curls"
            src={require('./images/Leg-Curl.gif')}
            className="rounded-lg bg-gray-100"
          />
          <img
            alt="Reverse Curls"
            src={require('./images/Leg-Press.gif')}
            className="rounded-lg bg-gray-100"
          />
        </div>
        ...
        <h3 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-1xl">AR Chest Models</h3>
          <p className="text-2xl text-gray-500 mb-5">
            Here is an AR model to aid you in further understanding the focus of which muscle to focus in your legs during a deadlift
          </p>
        </div>
      <LegDeadliftModel />
      <p className="text-2xl text-gray-500 mt-10">
            Here is a model to aid you in further understanding the muscles being targeted in your legs during a leg press
      </p>
      <LegPressModel />
      </div>
    </div>
